...
class Orders extends Component<{}> {
  ...
  componentDidMount() {
    // alert(JSON.stringify(this.props.userData.data));
  ...
  _retrieveData = (tabNo) => {
    ...
    /*
       ...
       AsyncStorage.getItem('filterData',(value)=>{
           ...
           if (value != null) {
             ...
             param={
              ...
              page:1,
              min:value.minRange,
              max:3200030,//value.maxRange,
              count:10,
              datemin:new Date(value.minDateRange).getTime(),
              datemax:new Date(value.maxDateRange).getTime(),
              sortBy:'',
              orderBy:'',
              driverId:this.props.userData.data._id
             }
      ...
      else
      {
        ...
        param={
          ...
          max:3200030,
          count:10,
          datemin:new Date().getTime()-2*24*60*60*1000,
          datemax:new Date().getTime(),
          sortBy:'',
          orderBy:'',
          driverId:this.props.userData.data._id
      ...
      <View style={styles.container}>
       <Header
        ...
        <ScrollableTabView onChangeTab={(data) => {
          ...
          //this._retrieveData(this.getTabData(data.i)).then(()=>{
