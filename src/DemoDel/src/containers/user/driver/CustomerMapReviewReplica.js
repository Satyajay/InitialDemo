...
getCurrentOrderStatus=()=>{
  ...
  this.props.UserActions.nextStop({
    driverId:'5ba512c5405cff32dcd952f4',lat_long:'49.2827,-123.1207'}).then((response) => {
...
/*
  fetch('http://18.212.245.222:9000/api/place-order/start-order/', {
    method: 'POST',
      headers: {
...
fetchDriverLocation=()=>{
     fetch('http://13.233.162.221:8283/api/drivers/getdriverlatlng?driverid=5ba512c5405cff32dcd952f4')
    .then((response) => response.json())
    .then((responseJson) => {
