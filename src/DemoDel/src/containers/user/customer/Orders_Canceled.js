...
class Orders_Canceled extends Component<{}> {
    ...
    render() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: Constants.Colors.White }]}>
                <HeaderBackgroundWithBackButton navigation={navigate} goBack={goBack} headerText={'Canceled Order'} />
...
export default connect(mapStateToProps, mapDispatchToProps)(Orders_Canceled);
