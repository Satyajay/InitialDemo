...
class Orders_Delivered extends Component<{}> {
    ...
    render() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: Constants.Colors.White }]}>
                <HeaderBackgroundWithBackButton navigation={navigate} goBack={goBack} headerText={'Delivered Order'} />
...
export default connect(mapStateToProps, mapDispatchToProps)(Orders_Delivered);
