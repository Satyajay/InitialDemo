...
class Canceled extends Component {
                ...
                if (result.status == 1) {
                    ...
                    for (i = 0; i < result.data.length; i++) {
                        ...
                        let obj = {
                            ...
                            time: canInfo.time,
                            expireTime: canInfo.orderExpireTime,
                            date: new_date,
                            maxTime: new_max,
                            minTime: new_min,
    ...
    //     let canc = await nextProps.canceledInfo;
    //     if (canc != null) {
    //         let cancelled = [];
                    ...
                    <Content>
                        ...
                        <List>
                            <FlatList
                                ...
                                renderItem={({ item }) =>
                                    <TouchableOpacity onPress={() => this.cancelDetail(item)}>
                                        <Card>
                                            <CardItem>
...
const mapStateToProps = state => ({
    ...
    canceledInfo: state.user.canceledData
});
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigation(Canceled));