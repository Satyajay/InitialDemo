...
class Home_Invoice extends Component<{}> {
    constructor(props) {
        super(props);
    }
    ...
    itemList(data) {
        ...
        return (
            <BoxShadow setting={shadowOpt}>
                <View style={{ backgroundColor: '#ffffff', height: Constants.BaseStyle.DEVICE_HEIGHT / 100 * 10/*20*/ }}>
...
export default connect(state => ({ state: state.CustomerReducer }))(Home_Invoice);
