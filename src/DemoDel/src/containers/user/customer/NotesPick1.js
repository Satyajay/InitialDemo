...
const Drops = [
    [{ "id": 0, "address": "Terrace, BC, Canada", "img": "none", "next": 3, "prev": 1, "lat": 54.5181925, "long": -128.6031539 }]
]
class NotesPick1 extends Component<{}> {
    constructor(props) {
        super(props);
        this.state = {
            available: true,
    ...
    nextAction() {
        // let pickUpArray = JSON.stringify(this.props.state.pickupArr);
        // console.log('Pickup++++', pickUpArray);
        // let dropOffArray = JSON.stringify(this.props.state.dropArr);
        // console.log('DropOff++++', dropOffArray);
        ...
        if (name == '' || name == null) {
            ...
            console.log('mainPickUp++', this.state.Picks)
            console.log('mainPickUpLength++', pickLength)
            let newPickLength = JSON.stringify(this.state.NewPicks.length)
            console.log('newPickUp++', this.state.NewPicks)
            console.log('newPickUpLength++', newPickLength)
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <HeaderMenu />
                <ScrollView style={{ flex: 1 }} decelerationRate={0.5}>
                    ...
                    <View style={{
                        ...
                        {
                            this.state.NewPicks.length == 3 ? <View style={styles.OtherCircle} /> : null
                        }
...
export default connect(state => ({ state: state.CustomerReducer, user: state.user }))(NotesPick1);