...
class Orders_Drafts extends Component<{}> {
  ...
  render() {
    ...
    return (
      <View style={[styles.container, { backgroundColor: Constants.Colors.White }]}>
        <HeaderBackgroundWithBackButton navigation={navigate} goBack={goBack} headerText={'Draft Order'} />
...
export default connect(mapStateToProps, mapDispatchToProps)(Orders_Drafts);
