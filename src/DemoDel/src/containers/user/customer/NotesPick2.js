...
class NotesPick2 extends Component<{}> {
    constructor(props) {
        super(props);
        this.state = {
            available: true,
    ...
    componentDidMount() {
        ...
        this.setState({ address: pickUpArray[1].address, Picks: pickUpArray })
    }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    ...
                    <View style={{
                        ...
                        {
                            this.state.Picks.length == 2 || this.state.NewPicks.length == 3 ? <Text style={{ fontSize: normalizeFont(12) }}>Pickup 2</Text> : null
                        }
                        {
...
export default connect(state => ({ state: state.CustomerReducer, user: state.user }))(NotesPick2);