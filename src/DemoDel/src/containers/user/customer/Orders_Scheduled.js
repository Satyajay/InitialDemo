...
class Orders_Scheduled extends Component<{}> {
  ...
  async componentWillReceiveProps(nextProps) {
    let detailsInfo = await nextProps.orderDetails;
  ...
  render() {
    ...
    return (
      <View style={[styles.container, { backgroundColor: Constants.Colors.White }]}>
        <HeaderBackgroundWithBackButton navigation={navigate} goBack={goBack} headerText={'Schedule Order'} />
...
export default connect(mapStateToProps, mapDispatchToProps)(Orders_Scheduled);
