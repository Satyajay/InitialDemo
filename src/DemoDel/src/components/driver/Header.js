...
export default class Header extends Component <{}>{
  ...
  render() {
    ...
    console.log("profile=========>",`${Connection.getBaseUrl()}/${this.state.profilePic}`)
        return(
            ...
            <View style={styles.navigationBar}>
                  ...
                  <Image source={{uri:`${Connection.getBaseUrl()}/${this.state.profilePic}`}} style={[styles.navIcons,{marginLeft:Constants.BaseStyle.DEVICE_WIDTH/100 * 4}]} resizeMode={'contain'}/>
                   ...
                   <View style={{justifyContent:'center',alignItems:'center',marginLeft:(Constants.BaseStyle.DEVICE_WIDTH/100)*5}}>
                     <Text style={[styles.HeaderTextStyle]}>{this.props.headerText}</Text>
                      ...
                      {this.props.toggleSwitch? <ToogleSwitch availabilityStatus={this.props.availabilityStatus}/>: <Switch
...
const styles = StyleSheet.create({
  ...
  navIcons:{
    ...
    marginTop:3.5,
    borderRadius:Constants.BaseStyle.DEVICE_HEIGHT/100 * 12
    //marginVertical: Constants.BaseStyle.DEVICE_WIDTH*1/100,
  },
  settingIcon:{
    height:Constants.BaseStyle.DEVICE_HEIGHT/100 * 7,
