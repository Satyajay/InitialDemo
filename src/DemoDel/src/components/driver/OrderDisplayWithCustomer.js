                ...
                <View style={styles.cardView}>
                  <View style={[styles.row,{marginBottom:10}]}>
                    ...
                    <View style={[styles.itemRight,{flex:0.40}]}>
                      ...
                      />
                      <Text style={styles.itemInBlue}>{moment.utc(this.state.timeleft).format('mm:ss')}{' min left'}{' left'}</Text>
                    </View>
                  </View>
                    ...
                    <View style={[styles.categoryRow,{marginHorizontal: (Constants.BaseStyle.DEVICE_WIDTH/100)*5}]}>
                      ...
                      <View style={{flex:1}}>
                        <SubmitButton
                          onPress={() => console.log('Hello')}
                          text={'NOTES'}
                          style={[styles.ButtonStyle,{marginBottom:10,marginTop:10,marginLeft:10,marginRight:10}]}
                          textStyle={[{fontSize:12,color:Constants.Colors.White}]}
                        />
                      </View>
                      {(parseInt(ButtonScreenNo)<4) ?
