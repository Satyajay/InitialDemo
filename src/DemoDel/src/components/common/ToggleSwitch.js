...
class ToogleSwitch extends Component{
      ...
      console.log("switch state",value);
        if(value){
          ...
          this.setState({status:value},()=>{ 
            ...
            this.setState({ quesOneYesActive:false,
              quesOneNoActive:false,
              quesTwoYesActive:false,
              quesTwoNoActive:false,})
            })
    ...
    questionOne(ansType){
          ...
          if(ansType){
            this.setState({quesOneYesActive: !this.state.quesOneYesActive,
            ...
            this.setState({quesOneNoActive: !this.state.quesOneNoActive,
    ...
    questionTwo(ansType){
      ...
      if(ansType){
        this.setState({quesTwoYesActive: !this.state.quesTwoYesActive,
        ...
        this.setState({quesTwoNoActive: !this.state.quesTwoNoActive,
