...
class SearchPlace extends Component {
    ...
    let { dispatch } = this.props.navigation;
      ...
      .then((responseData) => {
        ...
        if(responseData !== null)
        {
           ...
           {
             this.props.dispatch({type:'ADD_PICKUP',pickup:address,lat:arr.result.geometry.location.lat,long:arr.result.geometry.location.lng,
             ...
             this.props.dispatch({type:'ADD_DROP',drop:address,lat:arr.result.geometry.location.lat,
  ...
  //  var dataSource = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2}).cloneWithRows(this.state.searchList);
    return (
      <View style={{width: '100%',height:Constants.BaseStyle.DEVICE_HEIGHT/100 * 70, backgroundColor:Constants.Colors.WhiteSmoke,
