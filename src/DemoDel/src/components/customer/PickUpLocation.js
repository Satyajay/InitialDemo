...
class PickUpLocation extends Component<{}> {
          ...
          {index1==0 ?
            ...
            { this.props.tintColor ?
              ...
              <TouchableOpacity key={6} onPress={() => this.props.onPress()}>
                <Image key={7} source={Constants.Images.customer.plus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*5}]} resizeMode={'contain'}/>
              </TouchableOpacity>
            </View>
            :
            ...
            { this.props.tintColor ?
              ...
              { _img != 'plus' ?
                <TouchableOpacity key={12} onPress={() => context.onDelete(item.id)}>
                  <Image key={13} source={Constants.Images.customer.minus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*5}]} resizeMode={'contain'}/>
                </TouchableOpacity>
                :
                <TouchableOpacity key={14} onPress={() => this.props.onPress()}>
                  <Image key={15} source={Constants.Images.customer.plus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*5}]} resizeMode={'contain'}/>
                </TouchableOpacity>
              }
            </View>
          }
         ...
         <View key={1}>
           {index1==0 ?
             ...
             { this.props.tintColor ?
               ...
               <TouchableOpacity key={6} onPress={() => this.props.onPress()}>
                 <Image key={7} source={Constants.Images.customer.plus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*10}]} resizeMode={'contain'}/>
               </TouchableOpacity>
             </View>
             :
             <View key={8} style={[styles.flexRow]}>
             { this.props.tintColor ?
               ...
               { _img != 'plus' ?
                 <TouchableOpacity key={12} onPress={() => context.onDelete(data.id)}>
                   <Image key={13} source={Constants.Images.customer.minus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*10}]} resizeMode={'contain'}/>
                 </TouchableOpacity>
                 :
                 <TouchableOpacity key={14} onPress={() => this.props.onPress()}>
                   <Image key={15} source={Constants.Images.customer.plus} style={[styles.rowRight,{flex : 0.5,justifyContent:'flex-end',marginRight:(Constants.BaseStyle.DEVICE_WIDTH/100)*10}]} resizeMode={'contain'}/>
                 </TouchableOpacity>
               }
             </View>
           }
  ...
  onChangeOrder(data)
  {
    ...
    else
    {
      ...
      arr1.push({id:data.length-1,address : 'Choose Drop Off Another Location',img : 'plus',next:3,prev:1,lat:0,long:0});
  ...
  render() {
    let {
      list,tintColor,placeHolderText,onChangeText,PickDropFlag, active,
    } = this.props;
