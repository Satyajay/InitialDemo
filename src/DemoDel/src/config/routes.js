...
import NotesPick1 from "../containers/user/customer/NotesPick1";
import NotesPick2 from "../containers/user/customer/NotesPick2";
import NotesPick3 from "../containers/user/customer/NotesPick3";
import NotesDrop from "../containers/user/customer/NotesDrop";
...
export default routes = {
  ...
  NotesPick1: { screen: NotesPick1 },
  NotesPick2: { screen: NotesPick2 },
  NotesPick3: { screen: NotesPick3 },
  NotesDrop: { screen: NotesDrop },
