...
module.exports = StyleSheet.create({
  ...
  topView: {
    height: scaleHeight(40), borderRadius: scaleHeight(5), marginTop: scaleHeight(20),
    flexDirection: 'row',
  ...
  topView1: {
    height: scaleHeight(100), borderRadius: scaleHeight(5), marginTop: scaleHeight(0),
    flexDirection: 'row',
    justifyContent: 'center',
    alignItems: 'center',
    marginLeft: scaleWidth(20),
  ...
  bottomView: {
    height: scaleHeight(40), borderRadius: scaleHeight(5), marginTop: scaleHeight(12),
    flexDirection: 'row',
    justifyContent: 'center',
    alignItems: 'center',
    marginLeft: scaleWidth(20),
